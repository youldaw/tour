$(function (){
    ...
    $('.in-two input').on('click',function(e){
      e.preventDefault();
    ...
    var Monthpicker = (function () {
      ...
      c.prototype.InitIU = function () {
        ...
        for (
          var a =
              "<table><tr><td><span class='yearSwitch down'><img src='images/calendar-arrow-left.png'></span></td><td><div class='yearValue'>" +
              this.currentYear +
              "</div> </td><td><span class='yearSwitch up'><img src='images/calendar-arrow-right.png'></span> </td></tr> ",
            b = 0;
          4 > b;
          b++
        )
      ...
      c.defaultOpts = {
        ...
        maxValue: null,
        maxYear: null,
        monthLabels: "Январь Февраль Март Апрель Май Июнь Июль Август Сентябрь Октябрь Ноябрь Декабр ".split(" "),
        onSelect: null,
        onClose: null,
        allowNull: !0
      };
